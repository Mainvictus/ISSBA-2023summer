...
def main(args):
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        writer.add_scalar('Loss/Clean_Validation', test_loss_clean, epoch)
        writer.add_scalar('Loss/Triggered_Validation', test_loss_trigger, epoch)

        writer.add_scalar('Accuracy/Train', train_acc, epoch)
        writer.add_scalar('Accuracy/Clean_Validation', test_acc_clean, epoch)
        writer.add_scalar('Accuracy/Triggered_Validation', test_acc_trigger, epoch)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--tensorboard_logdir', type=str, default='logs', help='TensorBoard日志目录')
    # args.tensorboard_logdir = 'logs/' + args.net + '_bd_label_' + str(args.bd_label)
